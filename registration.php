...
if(isset($_POST['submit'] )) 
{
	...
	$query_result =mysqli_query($db, $mql);
	if($query_result){
         ...
         <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> Online Food Ordering and Delivery System </a>
                        ...
                        <div class="widget" >
                           <div class="widget-body">
							  ...
							  <form action="" method="post">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-6">
                                       <p> <input type="submit" value="Register" name="submit" class="btn theme-btn col-sm-6 m-1"> 
                                       <input type="reset" value="Refresh" name="reseting" class="btn btn-danger m-1 ">
                                    </p>
                                    </div>
