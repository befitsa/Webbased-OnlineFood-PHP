...
?>								  
    ...
    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info"> 
        <span class="price pull-left">ETB <?php echo $product['price']; ?></span>
        <input class="b-r-0" type="text" name="quantity" style="margin:10px;" value="1" size="2" />
        <input type="submit" class="btn theme-btn" style="margin:5px; border-radius:10px" value="Add To Cart" onclick="showMessage()" />
    </div>
</form>

<script>
    function showMessage() {
        var successMessage = "Your Delicious Food is added to cart!";
