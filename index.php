        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.avif">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order your Best Meal, it will be delivered soon. </h1>
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Recieve your order</h4> </div>
                    </div>
                </div>
            </div>
        </section>
        <section class="popular">
            <div class="container-fluid">
                <div class="title text-xs-center m-b-30">
                    ...
                    <hr>
                    <p class="lead">Easiest way to order your favourite food here in our site</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-3 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div style="text-align:center" class="price-btn-block"> <span class="price">ETB '.$r['price'].'</span></br>
                                                     <a style="border-radius:10px" href="dishes.php?res_id='.$r['rs_id'].'" class="btn btn-primary col-xs-12 ">Order Now</a> </div>
                                                </div>
            ...
            <div class="container-fluid" style='background-color:#339933'>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h4 style='color:white'>Choose a restaurant</h4>
                                    <p style='color:white'>Lots of Restaurants Work with us.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3 style='color:white'>Choose your Meal</h3>
                                <p style='color:white'>Quality meals are ready to satisfy your need.</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info " style='color:white; text-align:center'>Pay Using Banks and after confirmation, your order will be Delivered.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4 style='color:white'>Featured Restaurants</h4> </div>
                    </div>
                    <div class="col-sm-8">
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" style="widht:200px" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
