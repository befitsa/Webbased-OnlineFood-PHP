...
error_reporting(0);
session_start();
if(strlen($_SESSION['delivery_id'])==0)
  { 
...
header("refresh:1;url=view_order.php");
  }
...
<meta charset="utf-8">
    ...
    <link href="css/style.css" rel="stylesheet"> <style type="text/css" rel="stylesheet">
...
<table  border="0" cellspacing="0" cellpadding="0">
    ...
    <tr >
      ...
      <option value="in process">Ready</option>
