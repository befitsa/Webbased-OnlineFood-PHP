  ...
  <div style=" background-image: url('images/img/pimg.jpg');">
    ...
    if (isset($_POST['submit'])) {
      ...
      if (!empty($_POST["submit"])) {
        $query = "SELECT * FROM delivery WHERE code='$code'"; // Selecting matching records
        $result = mysqli_query($db, $query); // Executing query
        $row = mysqli_fetch_array($result);

        if (is_array($row)) {
          $_SESSION["delivery_id"] = $row['id'];
          $_SESSION["code"] = $row['code'];
          header("Location: delivery_reset.php");
        } else {
    ...
    <div class="module form-module">
      ...
      <div class="form">
        ...
        <a href="delivery_login.php" style="color:red">Go back to Login</a>
      </div>
