  ...
  <div style=" background-image: url('images/img/pimg.jpg');">
    ...
    if (isset($_POST['submit'])) {
      ...
      if ($password === $confirm_password) {
        ...
        $update_query = "UPDATE delivery SET password='$password' WHERE id='$admin_id' AND code='$code'";
        $result = mysqli_query($db, $update_query);

        if ($result) {
          $success = "Password reset successfully!";
          header("refresh:1;url=delivery_login.php");
        } else {
    ...
    <div class="module form-module">
      ...
      <div class="cta">Remembered your password? <a href="login.php" style="color:red">Login</a></div>
    </div>
