  ...
  <?php include("sidebar.php"); ?>
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><a href="all_orders.php" style="color:white">View Order</a></h4>
                            </div>
                                           ...
                                           <?php
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span>new order </button></center></td>
																		   <?php 
																			  }
																			...
																			if($status=="Paid")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Payment Paid</button></center></td>
																			<?php
																				}
																			if($status=="closed")
																				{
