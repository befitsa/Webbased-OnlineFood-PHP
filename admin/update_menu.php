    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                // Get the previous image file name for the specific menu ID
                $prev_image_query = mysqli_query($db, "SELECT img FROM dishes WHERE d_id = '$_GET[menu_upd]'");
                if ($prev_image_query && mysqli_num_rows($prev_image_query) > 0) {
                    ...
                    // Delete the previous image file from the "Res_img/dishes" folder
                    $prev_image_path = "Res_img/dishes/" . $prev_image_filename;
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" value="<?php echo $roww['price'];?>"  class="form-control" placeholder="ETB">
                                                   </div>
                                            </div>
